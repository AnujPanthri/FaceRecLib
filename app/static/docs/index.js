...
var data = {
  ...
  request_params: [
    {
      name: 'image',
      summary: 'Image to get face crops from.',
      type: 'File',
      required: '*',
    },
    {
      name: 'access_key',
      summary: 'access key related with your account.',
      type: 'json',
      required: '*',
    },
    {
      name: 'settings-parameter',
      summary: 'pass any settings for example "d_thres":0.3 .',
      type: 'json',
      required: '',
    },
  ],
  response_params: [
    {
      name: 'message',
      summary: '"success" if everything is fine.',
      type: 'Text',
    },
    {
      name: 'crops',
      summary: 'return list of crop images.',
      type: 'list of base64 values',
    },
  ],
};
...
function add_endpoint(data) {
  ...
  endpoint.innerHTML += `<p><b>route:&#9;</b><span class="api_route">${
    base_url + data['route']
  }</span></p>`;
